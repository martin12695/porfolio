...
@section('page-title', 'Edit Sketch')
        ...
        <div class="span12">
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form id="formAction" enctype="multipart/form-data" action="/dashboard/sketch/save/{{$info->id}}" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="control-group">
                            <label class="control-label">Title :</label>
                            <div class="controls">
                                <input id="prjTitle" name="title" type="text" class="span11" placeholder="Title" value="{{$info->title}}"required>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Short description :</label>
                            <div class="controls">
                                <input name="short_des" type="text" class="span11" placeholder="Short description" required value="{{$info->short_des}}">
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div id="imagePreview" style="background-image: url('{{url('/images/thum/'.$info->image)}}');">
