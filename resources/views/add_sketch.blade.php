...
@section('page-title', 'Add new Sketch')
        ...
        <div class="span12">
            ...
            @if(Session::get('response') && Session::get('response')==1)
                <div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
                    <h4 class="alert-heading"><i class="icon-ok"></i> Add sketch successfully!</h4>
                </div>
            @endif
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form id="formAction" enctype="multipart/form-data" action="/dashboard/sketch/save" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
